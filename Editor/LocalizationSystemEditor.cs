...
namespace Audune.Localization.Editor
{
  ...
  public class LocalizationSystemEditor : UnityEditor.Editor
  {
    ...
    protected void OnEnable()
    {
      ...
      _localeLoadersTypesMenu = typeof(LocaleLoader).CreateGenericMenuForChildTypes(Utils.UnityEditor.TypeDisplayOptions.None, null, type => target.gameObject.AddComponent(type));
      _localeSelectorsTypesMenu = typeof(LocaleSelector).CreateGenericMenuForChildTypes(Utils.UnityEditor.TypeDisplayOptions.None, null, type => target.gameObject.AddComponent(type));
    }
